<template>
  <div class="border-2 border-green-700 w-[100%] h-[auto] mt-4 text-left">
    <p>Add your name, phone number and address.</p>
    <div class="border-2 border-yellow-600 w-100 h-[auto] mt-10 flex flex-wrap justify-between">
      <!-- <form> -->
        ...
        <input class="border-b-2 border-red-400 w-[100%] mt-4 text-sm py-2" placeholder="Address details" type="text" />
      <!-- </form> -->
    </div>
  </div>
</template>
