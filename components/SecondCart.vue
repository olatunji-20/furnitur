  ...
  <div>
    <div class="w-[100%] h-[auto] mt-8">
      ...
      <div class="mx-auto w-[95%] h-[auto] pt-6">
        ...
        <p class="leading-10 text-gray-500">Discount  <span class="inline float-right font-bold text-red-500">{{ discount }}%</span></p>
        <p class="leading-10 text-gray-500">Total Price <span class="inline float-right font-bold text-2xl text-green-600">${{ (totalPrice() - ((discount/100) * totalPrice())).toFixed(2) }}</span></p>
