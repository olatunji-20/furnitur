<template>
    <div class="w-[100%] h-[auto] py-4">
        <div class="w-[100%] h-[auto] flex flex-col flex-wrap justify-between px-2 py-12 sm:flex-row md:w-[85%] mx-[auto]">
            <div class="footcard">
                <h3 class="leading-10 mb-2 font-bold">CUSTOMER SERVICE</h3>
                <ul class="foot">Help & FAQs</ul>
                <ul class="foot">Return & Refund</ul>
                <ul class="foot">Shipping Policy</ul>
                <ul class="foot">Custom and Taxes</ul>
                <ul class="foot">Customer's Reviews</ul>
            </div>
            <div class="footcard">
                <h3 class="leading-10 mb-2 font-bold">COMPANY</h3>
                <ul class="foot">About Japan with love</ul>
                <ul class="foot">Contact Us</ul>
                <ul class="foot">Specical Deals & Offers</ul>
                <ul class="foot">Terms of Service</ul>
                <ul class="foot">Privacy Policy</ul>
            </div>
            <div class="footcard">
                <h3 class="leading-10 mb-2 font-bold">HELP CENTER</h3>
            ...
            <div class="footcard">
                <h3 class="leading-10 mb-2 font-bold">RETURN & WARANTY</h3>
                <ul class="foot">Returns & Exchange Policy</ul>
                <ul class="foot">Returns Center</ul>
                <ul class="foot">Warranty Policy</ul>
                <ul class="foot">Warranty Registration</ul>
                <ul class="foot">Warranty Repair Center</ul>
            </div>
        </div>
        <div class="w-[100%] h-[auto] mx-[auto] flex flex-col justify-between py-[1.25rem] sm:flex-row md:w-[85%]">
