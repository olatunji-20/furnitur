<template>
  <div class="border-4 border-blue-700 w-[100%] h-[auto] flex flex-wrap justify-around">
    ...
    <div class="w-[50%] h-[550px] border-2 border-green-300 py-28 px-12">
        ...
        <!-- NUMBER SECTION-->
        <div class="border border-blue-400 my-12 w-[200px] h-[50px] bg-gray-100 flex justify-around rounded-md">
            <span class="text-2xl font-bold my-1 mx-4 cursor-pointer" @click="decrement">-</span>
            <input v-model="number" class="inputer w-[50px] font-bold bg-gray-100 text-xl text-center" type="number" :placeholder="number"/>
